...
document.write('			</li>');
document.write('			<li id="autores"><a href="../Publicacion_Documental/ViewListaAutor.html" class="dropdown-toggle"><i class="fa fa-pencil-square-o"></i><span>Autores</span><i class="fa fa-chevron-circle-down drop-icon"></i></a>');
document.write('				<ul class="submenu">');
