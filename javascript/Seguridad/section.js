...
document.write('			<li id="principal" class="active"><a href="../Administracion_Usuario_Grupo/viewPerfil.html">');
document.write('				<i class="fa fa-home"></i><span>Principal</span></a></li>');
document.write('			<li id="publicacion"><a href="" class="dropdown-toggle"><i class="fa fa-book"></i><span>Publicaciones</span><i class="fa fa-chevron-circle-down drop-icon"></i></a>');
...
document.write('			</li>');
document.write('			<li id="fichas"><a href="" class="dropdown-toggle"><i class="fa fa-file-text"></i><span>F. Bibliográficas</span><i class="fa fa-chevron-circle-down drop-icon"></i></a>');
document.write('				<ul class="submenu">');
document.write('					<li id="ver-ficha"><a href="../Publicacion_Documental/ViewListaFicha.html">Ver Fichas</a></li>');
document.write('				</ul>');
document.write('			</li>');
document.write('			<li id="usuarios"><a href="" class="dropdown-toggle"><i class="fa fa-users"></i><span>Usuarios</span>');
...
document.write('			</li>');
document.write('			<li id="grupos"><a href="" class="dropdown-toggle"><i class="fa fa-comments"></i><span>Grupos</span>');
document.write('					<i class="fa fa-chevron-circle-down drop-icon"></i></a>');
document.write('				<ul class="submenu">');
...
document.write('			</li>');
document.write('			<li id="autores"><a href="" class="dropdown-toggle"><i class="fa fa-pencil-square-o"></i><span>Autores</span><i class="fa fa-chevron-circle-down drop-icon"></i></a>');
document.write('				<ul class="submenu">');
document.write('					<li id="ver-autor"><a href="../Publicacion_Documental/ViewListaAutor.html">Ver Autores</a></li>');
document.write('				</ul>');
document.write('			</li>');
document.write('			<li id="idiomas"><a href="" class="dropdown-toggle"><i class="fa fa-globe"></i><span>Idiomas</span>');
document.write('					<i class="fa fa-chevron-circle-down drop-icon"></i></a>');
document.write('				<ul class="submenu">');
document.write('					<li id="ver-idioma"><a href="../Publicacion_Documental/ViewListaIdioma.html">Ver Idiomas</a></li>');
document.write('				</ul>');
document.write('			</li>');
document.write('			<li id="etiquetas"><a href="" class="dropdown-toggle"><i class="fa fa-star"></i><span>Etiquetas</span>');
document.write('					<i class="fa fa-chevron-circle-down drop-icon"></i></a>');
document.write('				<ul class="submenu">');
document.write('					<li id="ver-etiqueta"><a href="../Publicacion_Documental/ViewListaEtiqueta.html">Ver Etiquetas</a></li></ul>');
document.write('			</li>');
document.write('			<li id="maestros"><a href="" class="dropdown-toggle"><i class="fa fa-files-o"></i><span>Maestros</span>');
document.write('					<i class="fa fa-chevron-circle-down drop-icon"></i></a>');
document.write('				<ul class="submenu">');
...
document.write('			</li>');
document.write('			<li id="enlaces"><a href="" class="dropdown-toggle"><i class="fa fa-link"></i>');
...
document.write('			</li>');
document.write('			<li id="permiso"><a href="" class="dropdown-toggle"><i class="fa fa-key"></i><span>Permisos</span>');
document.write('					<i class="fa fa-chevron-circle-down drop-icon"></i></a>');
document.write('					<ul class="submenu">');
