function validarVisibilidadTabla(data){
	...
	result = $.grep(data, function(e){ return e.IDFUNCIONALIDAD === "41"; });
	if (result.length === 0){
		$(location).attr('href','../../front/Seguridad/errorPermiso.html');
	}else{ 
		//permisover = $.grep(data, function(e){ return e.IDFUNCIONALIDAD === "17"; });
		permisoreg = $.grep(data, function(e){ return e.IDFUNCIONALIDAD === "42"; });
		permisomod = $.grep(data, function(e){ return e.IDFUNCIONALIDAD === "43"; });
		permisodel = $.grep(data, function(e){ return e.IDFUNCIONALIDAD === "44"; });
