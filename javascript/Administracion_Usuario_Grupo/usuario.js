...
function cargaListaUsuario(data){
	...
	for(var i=0; i < data.length ; i++){
		...
		fila+= '<a  href="ViewVerUsuario.html" class="ver-usuario table-link" IDUSUARIO='+data[i]["IDUSUARIO"]+'><span class="fa-stack"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-search fa-stack-1x fa-inverse"></i></span></a>';
